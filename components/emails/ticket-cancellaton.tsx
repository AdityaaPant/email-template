      ...
      <Tailwind>
        <Body className="bg-[#0A0A0A] font-sans py-[40px] px-[20px]">
          <Container className="bg-[#0A0A0A] mx-auto max-w-[600px]">
            ...
            {/* Thank You Banner */}
            <Section
              className="bg-[#B9A210] rounded-[12px] mb-[16px] text-center"
              style={{ padding: "20px" }}
            >
              <div
              ...
              >
                <Img
                  src="https://assets.avenueticketing.com/email-template/cancel.png"
                  alt="Checkmark Icon"
                  width="50"
                  height="50"
                  style={{ display: "block" }}
            ...
            <Section className="mb-[24px]" style={{ padding: "0 4px" }}>
              <Text
                className="text-white text-[18px] font-medium mb-[16px] text-large-responsive"
              ...
              >
                We successfully cancelled your booking!.
              </Text>
              ...
              >
                Your refund will be processed to the original payment used at
                the time of purchase. Once funds are received from the event
                organizer, which is usually completed within 30 days.
              </Text>
