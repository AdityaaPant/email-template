...
const RefundRequestEmail = (props: any) => {
  ...
  return (
    <Html lang="en" dir="ltr">
      ...
      <Tailwind>
        <Body className="bg-black font-sans py-[40px] px-[20px]">
          <Container className="bg-black mx-auto max-w-[600px]">
            {/* Header */}
              ...
              <Row>
                <Column className="w-auto">
                  <div className="flex items-center gap-[8px]">
                    ...
                    <Text className="text-white text-[20px] font-medium m-0">
                      Avenue
                    </Text>
                  </div>
                </Column>
                <Column className="text-right">
                  <Link
                    href="#"
                    className="text-gray-400 text-[14px] no-underline"
                  >
                    <svg
                      width="16"
                      height="16"
            ...
            {/* Main Heading */}
            <Heading className="text-white text-[40px] font-bold leading-[1.2] mb-[40px] mt-0">
              We've Received Your Refund Request
            </Heading>

            {/* Content */}
            <Section className="mb-[40px]">
              <Text className="text-white text-[16px] leading-[1.6] mb-[20px] mt-0">
                Hi {attendeeName},
              </Text>

              <Text className="text-gray-300 text-[16px] leading-[1.6] mb-[20px] mt-0">
              ...
              <Text className="text-white text-[16px] leading-[1.6] mt-[20px] mb-0">
                — Avenue Fan Support
              </Text>
            </Section>

            {/* Help Section */}
            <Section className="bg-[#000000] rounded-[12px] p-[24px] mb-[40px]">
              <div className=" flex items-center gap-[8px] mb-[16px]">
                ...
                <Text className="text-white text-[18px] font-semibold m-0">
                  Need Help?
                </Text>
              </div>

              <Hr className="border-[#333333] my-[16px]" />

              <Text className="text-white text-[16px] font-semibold mb-[4px] mt-[16px]">
                We are here for you
              </Text>
              <Text className="text-gray-400 text-[14px] mb-[24px] mt-0">
                Reach out to us over email or phone 24/7
              </Text>

              <Row>
                <Column className="w-[50%] pr-[10px]">
                  <Text className="text-white text-[14px] mb-[8px] mt-0">
                    Phone number
                  </Text>
                  <div className="bg-[#0a0a0a] border border-[#333333] rounded-full p-[12px] flex items-center gap-[8px]">
                    <span className="text-[16px]">🇺🇸</span>
                    <Text className="text-white text-[15px] m-0">
                      (555) 987 654
                    </Text>
                  </div>
                </Column>

                <Column className="w-[50%] pl-[10px]">
                  <Text className="text-white text-[14px] mb-[8px] mt-0">
                    Email Address
                  </Text>
                  <div className="bg-[#0a0a0a] border border-[#333333] rounded-full p-[12px] flex items-center gap-[8px]">
            ...
            <Section className="text-center pt-[40px]">
              ...
              <Text className="text-gray-500 text-[14px] my-[8px]">
                Avenue | 101 Ave, 10th Floor | Hawaii
              </Text>
              <Text className="text-gray-500 text-[14px] mt-[4px] mb-0">
